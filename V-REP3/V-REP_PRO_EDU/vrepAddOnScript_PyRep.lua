...
function sysCall_beforeInstanceSwitch()
    print("Before switching to another instance (add-on script)")
end

function sysCall_afterInstanceSwitch()
    print("After switching to another instance (add-on script)")
end

function sysCall_beforeSimulation()
    print("Simulation starting (add-on script)")
end

function sysCall_afterSimulation()
    print("Simulation ended (add-on script)")
end
